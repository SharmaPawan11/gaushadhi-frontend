...
export namespace UpdateAddress {
  ...
  export type UpdateCustomerAddress = NonNullable<
    UpdateAddressMutation['updateCustomerAddress']
  >;
}
...
export namespace ChangePassword {
  ...
  export type UpdateCustomerPassword = NonNullable<
    ChangePasswordMutation['updateCustomerPassword']
  >;
  export type SuccessInlineFragment = DiscriminateUnion<
    NonNullable<ChangePasswordMutation['updateCustomerPassword']>,
    { __typename?: 'Success' }
  >;
}
...
export namespace ChangeEmailAddress {
  ...
  export type RequestUpdateCustomerEmailAddress = NonNullable<
    ChangeEmailAddressMutation['requestUpdateCustomerEmailAddress']
  >;
  export type SuccessInlineFragment = DiscriminateUnion<
    NonNullable<
      ChangeEmailAddressMutation['requestUpdateCustomerEmailAddress']
...
export namespace UpdateCustomerDetails {
  ...
  export type UpdateCustomer = NonNullable<
    UpdateCustomerDetailsMutation['updateCustomer']
  >;
}
...
export namespace GetAccountOverview {
  ...
  export type ActiveCustomer = NonNullable<
    GetAccountOverviewQuery['activeCustomer']
  >;
}
...
export namespace GetOrder {
  ...
  export type ShippingAddress = NonNullable<
    NonNullable<GetOrderQuery['orderByCode']>['shippingAddress']
  >;
  export type BillingAddress = NonNullable<
    NonNullable<GetOrderQuery['orderByCode']>['billingAddress']
  >;
}
...
export namespace GetOrderList {
  ...
  export type Orders = NonNullable<
    NonNullable<GetOrderListQuery['activeCustomer']>['orders']
  >;
...
export namespace VerifyChangeEmailAddress {
  ...
  export type UpdateCustomerEmailAddress = NonNullable<
    VerifyChangeEmailAddressMutation['updateCustomerEmailAddress']
  >;
  export type SuccessInlineFragment = DiscriminateUnion<
    NonNullable<VerifyChangeEmailAddressMutation['updateCustomerEmailAddress']>,
    { __typename?: 'Success' }
  >;
}
...
export namespace RequestPasswordReset {
  ...
  export type RequestPasswordReset = NonNullable<
...
export namespace Register {
  ...
  export type RegisterCustomerAccount = NonNullable<
    RegisterMutation['registerCustomerAccount']
  >;
  export type SuccessInlineFragment = DiscriminateUnion<
...
export namespace ResetPassword {
  ...
  export type ResetPassword = NonNullable<
    ResetPasswordMutation['resetPassword']
  >;
  export type CurrentUserInlineFragment = DiscriminateUnion<
...
export namespace Verify {
  ...
  export type VerifyCustomerAccount = NonNullable<
    VerifyMutation['verifyCustomerAccount']
  >;
  export type CurrentUserInlineFragment = DiscriminateUnion<
...
export namespace GetOrderByCode {
  ...
  export type Customer = NonNullable<
    NonNullable<GetOrderByCodeQuery['orderByCode']>['customer']
  >;
...
export namespace AddPayment {
  ...
  export type AddPaymentToOrder = NonNullable<
    AddPaymentMutation['addPaymentToOrder']
  >;
}
...
export namespace TransitionToAddingItems {
  ...
  export type TransitionOrderToState = NonNullable<
    TransitionToAddingItemsMutation['transitionOrderToState']
  >;
}
...
export namespace GetShippingAddress {
  ...
  export type ShippingAddress = NonNullable<
    NonNullable<GetShippingAddressQuery['activeOrder']>['shippingAddress']
  >;
}
...
export namespace SetShippingAddress {
  ...
  export type SetOrderShippingAddress = NonNullable<
    SetShippingAddressMutation['setOrderShippingAddress']
  >;
...
export namespace SetShippingMethod {
  ...
  export type SetOrderShippingMethod = NonNullable<
...
export namespace SetCustomerForOrder {
  ...
  export type SetCustomerForOrder = NonNullable<
...
export namespace TransitionToArrangingPayment {
  ...
  export type TransitionOrderToState = NonNullable<
    TransitionToArrangingPaymentMutation['transitionOrderToState']
  >;
}
...
export namespace GetOrderForCheckout {
  ...
  >;
  export type ShippingAddress = NonNullable<
    NonNullable<GetOrderForCheckoutQuery['activeOrder']>['shippingAddress']
  >;
}
...
export namespace GetProductDetail {
  ...
  export type Variants = NonNullable<
    NonNullable<
      NonNullable<GetProductDetailQuery['product']>['variants']
    >[number]
  >;
  ...
  >;
  export type FeaturedAsset = NonNullable<
    NonNullable<GetProductDetailQuery['product']>['featuredAsset']
  >;
  export type Assets = NonNullable<
    NonNullable<NonNullable<GetProductDetailQuery['product']>['assets']>[number]
  >;
  export type Collections = NonNullable<
    NonNullable<
      NonNullable<GetProductDetailQuery['product']>['collections']
    >[number]
  >;
...
export namespace CreateAddress {
  ...
  export type CreateCustomerAddress = NonNullable<
    CreateAddressMutation['createCustomerAddress']
  >;
}
...
export namespace SignIn {
  ...
  export type CurrentUserInlineFragment = DiscriminateUnion<
    NonNullable<SignInMutation['login']>,
    { __typename?: 'CurrentUser' }
  >;
}
...
export namespace GetActiveChannel {
  ...
  export type ActiveChannel = NonNullable<
...
export type UpdateCustomerDetailsMutation = { __typename?: 'Mutation' } & {
  updateCustomer: { __typename?: 'Customer' } & Pick<
    Customer,
...
export type GetAccountOverviewQuery = { __typename?: 'Query' } & {
  ...
  orderByCode?: Maybe<
    { __typename?: 'Order' } & {
      shippingAddress?: Maybe<
        { __typename?: 'OrderAddress' } & OrderAddressFragment
      >;
        ...
        orders: { __typename?: 'OrderList' } & Pick<OrderList, 'totalItems'> & {
            items: Array<
              { __typename?: 'Order' } & Pick<
                Order,
                'id' | 'updatedAt' | 'code' | 'state' | 'currencyCode' | 'total'
              >
            >;
          };
      }
...
export type ResetPasswordMutation = { __typename?: 'Mutation' } & {
  resetPassword:
    | ({ __typename?: 'CurrentUser' } & Pick<CurrentUser, 'id' | 'identifier'>)
    | ({
        __typename?: 'NativeAuthStrategyError';
      } & ErrorResult_NativeAuthStrategyError_Fragment)
    | ({
...
export type GetOrderByCodeQuery = { __typename?: 'Query' } & {
  orderByCode?: Maybe<
    { __typename?: 'Order' } & Pick<Order, 'updatedAt'> & {
        customer?: Maybe<
          { __typename?: 'Customer' } & Pick<
            Customer,
...
export type GetEligiblePaymentMethodsQuery = { __typename?: 'Query' } & {
  eligiblePaymentMethods: Array<
    { __typename?: 'PaymentMethodQuote' } & Pick<
      PaymentMethodQuote,
      'id' | 'code' | 'eligibilityMessage' | 'isEligible'
    >
  >;
};
...
export type GetNextOrderStatesQuery = { __typename?: 'Query' } & Pick<
  Query,
  'nextOrderStates'
>;

export type TransitionToAddingItemsMutationVariables = Exact<{
  [key: string]: never;
}>;

export type TransitionToAddingItemsMutation = { __typename?: 'Mutation' } & {
...
export type GetShippingAddressQuery = { __typename?: 'Query' } & {
  activeOrder?: Maybe<
...
export type GetEligibleShippingMethodsQuery = { __typename?: 'Query' } & {
  eligibleShippingMethods: Array<
    { __typename?: 'ShippingMethodQuote' } & Pick<
      ShippingMethodQuote,
      'id' | 'name' | 'description' | 'price' | 'priceWithTax' | 'metadata'
    >
  >;
};
...
export type TransitionToArrangingPaymentMutationVariables = Exact<{
  [key: string]: never;
}>;
...
export type GetOrderForCheckoutQuery = { __typename?: 'Query' } & {
  activeOrder?: Maybe<
    { __typename?: 'Order' } & {
      shippingAddress?: Maybe<
        { __typename?: 'OrderAddress' } & OrderAddressFragment
...
export type GetAvailableCountriesQuery = { __typename?: 'Query' } & {
  availableCountries: Array<{ __typename?: 'Country' } & CountryFragment>;
};
...
> & {
    ...
    discounts: Array<
      { __typename?: 'Discount' } & Pick<
        Discount,
        'amount' | 'amountWithTax' | 'description' | 'adjustmentSource' | 'type'
      >
    >;
  };
...
export type GetCartTotalsQuery = { __typename?: 'Query' } & {
  activeOrder?: Maybe<
    { __typename?: 'Order' } & Pick<
      Order,
      'id' | 'active' | 'totalQuantity' | 'totalWithTax'
    >
  >;
};
...
export type GetProductDetailQuery = { __typename?: 'Query' } & {
  product?: Maybe<
    ...
    > & {
        ...
        collections: Array<
          { __typename?: 'Collection' } & Pick<Collection, 'id' | 'slug'> & {
              breadcrumbs: Array<
                { __typename?: 'CollectionBreadcrumb' } & Pick<
...
export type AddToCartMutation = { __typename?: 'Mutation' } & {
  addItemToOrder:
    | ({ __typename?: 'InsufficientStockError' } & {
        order: { __typename?: 'Order' } & CartFragment;
      } & ErrorResult_InsufficientStockError_Fragment)
    | ({
        __typename?: 'NegativeQuantityError';
      } & ErrorResult_NegativeQuantityError_Fragment)
  ...
  > & {
      items: Array<
        { __typename?: 'SearchResult' } & Pick<
          SearchResult,
          'productId' | 'slug' | 'productName' | 'description'
        > & {
            priceWithTax:
              | ({ __typename?: 'PriceRange' } & Pick<
                  PriceRange,
                  'min' | 'max'
                >)
              | { __typename?: 'SinglePrice' };
      ...
      >;
      facetValues: Array<
        { __typename?: 'FacetValueResult' } & Pick<
          FacetValueResult,
          'count'
        > & {
            facetValue: { __typename?: 'FacetValue' } & Pick<
              FacetValue,
              'id' | 'name'
            > & {
...
export type GetActiveChannelQuery = { __typename?: 'Query' } & {
  activeChannel: { __typename?: 'Channel' } & Pick<
    Channel,
    'id' | 'code' | 'currencyCode' | 'defaultLanguageCode'
  >;
};
