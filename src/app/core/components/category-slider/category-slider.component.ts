...
export class CategorySliderComponent implements OnInit, AfterViewInit {
  @ViewChild('categoryContainer', { read: ElementRef })
  categoryContainer!: ElementRef<HTMLUListElement>;
  gridColumnStyle = {};
  ...
  ngAfterViewInit(): void {
    this.noOfColumnsInOneSlide = Math.floor(
      this.categoryContainer.nativeElement.offsetWidth / 225
    );
    // setTimeout(() => {
